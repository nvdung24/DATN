...
namespace CoV.Service.Service
{
    ...
    public class OrderDetailsService : IOrderDetailsService
    {
        ...
        public void Delete1(int id)
        {
            ...
            if (orderDetalses != null && orderDetalses.StatusId == 1)
            {            
                _unitOfWork.OrderDetailsRespository.Delete(orderDetalses);
                _unitOfWork.Save();
            }
            else if(orderDetalses != null && orderDetalses.StatusId == 5)
            {
                orderDetalses.StatusId = 1002;
                _unitOfWork.Save();
            }
        }
        ...
        {
            var orderDetail = _unitOfWork.OrderDetailsRespository.GetById(id);
            orderDetail.StatusId = 1003;
            _unitOfWork.Save();
        }

        public void CancelOrderDelete(int id)
        {
            var orderDetail = _unitOfWork.OrderDetailsRespository.GetById(id);
