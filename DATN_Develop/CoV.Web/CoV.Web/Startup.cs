...
namespace CoV.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IProductDesciptionService, ProductDesciptionService>();
            ...
            services.AddAutoMapper(typeof(ProductDescriptionMapper));
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("Employee", policy => policy.RequireAssertion(context =>
                     context.User.IsInRole(Constants.Role.Admin) || context.User.IsInRole(Constants.Role.Employee)));
                options.AddPolicy("Accountant", policy => policy.RequireAssertion(context =>
                    context.User.IsInRole(Constants.Role.Accountant) || context.User.IsInRole(Constants.Role.Admin) || context.User.IsInRole(Constants.Role.Employee)));
                options.AddPolicy("Shiper", policy => policy.RequireAssertion(context =>
                    context.User.IsInRole(Constants.Role.Shiper) || context.User.IsInRole(Constants.Role.Accountant) || context.User.IsInRole(Constants.Role.Admin) || context.User.IsInRole(Constants.Role.Employee)));
            });
